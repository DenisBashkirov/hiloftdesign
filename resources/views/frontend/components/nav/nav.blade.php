...
<span class="js-header-nav-dropdown">
    ...
    <div class="hidden header-nav-dropdown-wrapper xl:absolute xl:left-0">
        ...
        <a class="header-nav-dropdown-item" href="{{ route('services', ['service' => 'dizayn-kvartir']) }}">Дизайн квартир</a>
        <a class="header-nav-dropdown-item" href="{{ route('services', ['service' => 'dizayn-domov']) }}">Дизайн домов и коттеджей</a>
    </div>
    </div>
</span>
