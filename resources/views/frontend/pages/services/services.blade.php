                ...
                <div class="swiper-wrapper">
                    ...
                    @component('frontend.components.cards.special-offer-card', [
                       ...
                       'options_list'=>[
                           ...
                           'Подготовим варианты планировочных',
                    ...
                    @component('frontend.components.cards.special-offer-card', [
                       ...
                       'price'=>'2900',
                       'options_list'=>[
                           'Консультация перед покупкой квартиры (до 5 вариантов)',
                           'По любым вопросам ремонта (технические решения, свет, виды отделки – плюсы/минусы, свет и тд)',
                       ],
