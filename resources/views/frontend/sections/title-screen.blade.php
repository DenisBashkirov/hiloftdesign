<section class="title-screen bg:title-screen--home h-screen text-white xs-sm:pt-12 md-xl:pt-20">
    ...
    <div class="xs-lg:container xl:container-fluid xl:pl-8 relative flex flex-col xs-md:justify-around lg-xl:justify-center h-full">
        ...
        <div class="xs-md:flex xs-md:flex-col xs-md:flex-center">
            ...
            <h1 class="lg-xl:w-100 font-bold xs:text-xl sm:text-3xl md:text-5xl lg-xl:text-4xl xs-md:text-center">Современный дизайн интерьеров</h1>
        </div>
